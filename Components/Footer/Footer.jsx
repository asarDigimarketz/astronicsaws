    ...
    <footer className=" footerset  bg-color--1">
      <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-8 border-t border-gray-100 pt-8 sm:grid-cols-2 lg:grid-cols-4 lg:pt-16">
          ...
          <div>
            <p className="font-medium text-white">Madurai</p>
            ...
            <ul className="mt-6 p-0 space-y-4 text-sm">
              ...
              <li>
                <Link
                  href="tel:+91 73395 66684"
                  className="text-white transition hover:opacity-75 d-flex"
                >
                  {" "}
                  <FaPhoneAlt /> &nbsp;+91 73395 66684{" "}
                </Link>
              </li>
              <li>
                <Link
                  href="tel:+91 73395 66682"
                  className="text-white transition hover:opacity-75 d-flex"
                >
                  {" "}
                  <FaPhoneAlt /> &nbsp;+91 73395 66682{" "}
                </Link>
              </li>
              <li>
                <Link
                  href="tel:+91 73395 66683"
                  className="text-white transition hover:opacity-75 d-flex"
                >
                  {" "}
                  <FaPhoneAlt /> &nbsp;+91 73395 66683{" "}
                </Link>
              </li>
          ...
          <div>
            <p className="font-medium text-white">Dindigul</p>
