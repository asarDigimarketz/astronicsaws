              ...
              >
                ...
                <div className="px-4 py-2 flex flex-col flex-grow">
                  ...
                  <div className="flex justify-start items-center">
                    <h5 className="text-black font-bold text-sm px-1 mt-1 text-nowrap">
                      <FaIndianRupeeSign className="inline-flex" />
                      {product.price.toLocaleString("en-IN")}
                    </h5>
                    <h5 className="text-red-500 text-sm line-through px-2 text-nowrap">
                      <FaIndianRupeeSign className="inline-flex" />
                      {originalPrice.toLocaleString("en-IN")}
                    </h5>
                    <h5 className="text-green-500 text-sm text-nowrap">
